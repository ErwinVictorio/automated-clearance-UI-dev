...
function DepartmetList() {
    const [isOpenModalTeacher, setIsOpenModalTeacher] = useState<boolean>(false);
    ...
    return (
        <main className="min-h-screen bg-gray-50">
            ...
            <section className="p-6 bg-white shadow-sm flex items-center justify-between">
                ...
                <Button onClick={() => setIsOpenModalTeacher(true)} className="flex items-center gap-2 cursor-pointer text-white">
